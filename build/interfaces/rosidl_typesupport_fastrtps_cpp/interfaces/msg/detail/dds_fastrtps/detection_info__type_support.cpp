...
#include "interfaces/msg/detail/detection_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const interfaces::msg::DetectionInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::DetectionInfo *>(
    untyped_ros_message);
...
{
  return max_serialized_size_DetectionInfo(full_bounded, 0);
}
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_DetectionInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, DetectionInfo)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_DetectionInfo__handle;
}
