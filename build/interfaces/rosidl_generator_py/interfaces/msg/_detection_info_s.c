...
bool interfaces__msg__detection_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // color
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->color.data;
...
{
  /* NOTE(esteve): Call constructor of DetectionInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._detection_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DetectionInfo");
  ...
  {  // color
    ...
    if (ros_message->color.size > 0) {
      ...
      uint8_t * src = &(ros_message->color.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->color.size * sizeof(uint8_t));
      assert(data != NULL);
